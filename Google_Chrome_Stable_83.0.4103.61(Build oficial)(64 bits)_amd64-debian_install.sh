#!/bin/bash
# Ultima actualización: 12/03/2020  Versión Versión 83.0.4103.61 (Build oficial) (64 bits)
cd /
#
...
echo 'Version=83.0.4103.61 (Build oficial) (64 bits) empaquetado de .deb' >> google-chrome.desktop
...
echo 'Version=83.0.4103.61 (Build oficial) (64 bits) empaquetado de .deb' >> README.txt
