#!/bin/bash
# Ultima actualización: 05/05/2019
cd /
#
...
echo 'Version=74.3729.131 (Build oficial) (64 bits) empaquetado de .deb' >> google-chrome.desktop
...
echo 'Version=74.3729.131 (Build oficial) (64 bits) empaquetado de .deb' >> README.txt
