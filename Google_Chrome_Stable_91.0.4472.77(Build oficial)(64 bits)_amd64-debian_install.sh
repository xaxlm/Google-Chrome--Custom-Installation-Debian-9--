...
echo 'Version=96.0.4664.110-1 (Build oficial) (64 bits) empaquetado de .deb' >> google-chrome.desktop
...
echo 'Version=996.0.4664.110-1 (Build oficial) (64 bits) empaquetado de .deb' >> README.txt
