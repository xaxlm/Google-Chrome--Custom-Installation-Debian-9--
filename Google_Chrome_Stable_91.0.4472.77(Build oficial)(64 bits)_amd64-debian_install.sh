#!/bin/bash
# Ultima actualización: 06/061/2021  Versión Versión 91.0.4472.77 (Build oficial) (64 bits)
cd /
#
...
echo 'Version=91.0.4472.77 (Build oficial) (64 bits) empaquetado de .deb' >> google-chrome.desktop
...
echo 'Version=91.0.4472.77 (Build oficial) (64 bits) empaquetado de .deb' >> README.txt
