...
echo 'Version=76.0.3809.100-1 (Build oficial) (64 bits) empaquetado de .deb' >> google-chrome.desktop
...
echo 'Version=76.0.3809.100-1 (Build oficial) (64 bits) empaquetado de .deb' >> README.txt
