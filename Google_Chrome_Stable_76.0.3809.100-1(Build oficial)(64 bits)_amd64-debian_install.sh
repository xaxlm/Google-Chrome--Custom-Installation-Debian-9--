#!/bin/bash
# Ultima actualización: 18/09/2019
cd /
#
...
echo 'Version=77.0.3865.90 (Build oficial) (64 bits) empaquetado de .deb' >> google-chrome.desktop
...
echo 'Version=77.0.3865.90 (Build oficial) (64 bits) empaquetado de .deb' >> README.txt
